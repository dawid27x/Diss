...
const UICustomisationForm = ({ onSave }) => {
  ...
  const aiData = JSON.parse(localStorage.getItem("customisationFormData")) || {};
  ...
  <div className="text-center mb-6">
    <h2 className="text-2xl font-bold">{aiData.aiName || "Your Chatbot"}</h2>
    <p className="text-sm">{aiData.role || "AI Assistant"}</p>
  </div>

  <div style={{color: formData.textColor}} className="bg-white p-4 rounded mb-4">
